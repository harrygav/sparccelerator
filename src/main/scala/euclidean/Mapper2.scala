...
object Mapper2 {
  ...
  def main(args: Array[String]) {
    ...
    val tupleFile = "/home/harry/Desktop/semester11/thesis/arrow/tuple5_2gb.csv"
    ...
    val tuplesWithDist = tupleData.mapPartitions(tuples => {
      ...
      val newTuples = tuples.map(tuple => {
        ...
        val pointX1 = tuple.get(2).asInstanceOf[Int]
        val pointY1 = tuple.get(3).asInstanceOf[Int]

        val dist = Math.sqrt(Math.pow(pointX - pointY, 2) + Math.pow(pointX1 - pointY1, 2))
